...
<div class="user-info">
	<div class="form-group row">
		...
		<div class="col-md-10">
			<?php 
				if($tlhr_edit_id ==0){
			?>
			<select class="form-control" name="user_name" id="user_name" required autofocus>
			...
			<?php }
				...
				<select class="form-control" name="user_name" id="user_name" autofocus>
			    <option  value="<?php echo @$selected_factors_list[0]['tlhr_name']; ?>"><?php echo @$selected_factors_list[0]['Firstname'].' '.@$selected_factors_list[0]['Lastname'] ; ?></option>
				</select> 
	...
	<div class="form-group row">
		...
		<div class="col-md-4">
			<select name="user_designation" id="user_designation" class="form-control" required autofocus>
					<option value="">Select Designation</option>
				<?php foreach ($all_designations as $key => $value): ?>
					<option value="<?php echo $value['designation_id']; ?>" <?php if(@$selected_factors_list[0]['tlhr_designation'] ==$value['designation_id']){ echo 'selected';} ?>><?php echo $value['designation_name']; ?></option>
				<?php endforeach ?>
			</select>
		...
		<div class="col-md-4">
			<select name="user_department" id="user_department" class="form-control" required autofocus>
					<option value="">Select Department</option>
				<?php foreach ($all_departments as $key => $value): ?>
					<option value="<?php echo $value['dept_id']; ?>" <?php if(@$selected_factors_list[0]['tlhr_department'] ==$value['dept_id']){ echo 'selected';} ?>><?php echo $value['dept_name']; ?></option>
				<?php endforeach ?>
			</select>
	...
	<div class="form-group row">
		...
		<div class="col-md-4">
			<input type="text" name="user_joining_date" class="form-control datepicker" placeholder="Enter Joining Date" value="<?php if(!empty(@$selected_factors_list[0]['tlhr_joining_date'])){echo date("Y-m-d",strtotime(@$selected_factors_list[0]['tlhr_joining_date']));} ?>"  required autofocus>
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-4">
			<select class="form-control" name="evaluation_quarter" id="evaluation_quarter" required>
				...
				<option value="Fall" <?php if(@$selected_factors_list[0]['tlhr_quarter'] == 'Fall'){echo 'selected="selected"'; } ?>>Fall</option>
				<option value="Winter" <?php if(@$selected_factors_list[0]['tlhr_quarter'] == 'Winter'){echo 'selected="selected"'; } ?>>Winter</option>
				<option value="Spring" <?php if(@$selected_factors_list[0]['tlhr_quarter'] == 'Spring'){echo 'selected="selected"'; } ?>>Spring</option>	
			</select>
		</div>
	</div>
	<div class="form-group row">
		...
		<div class="col-md-4">
			<select name="user_project" id="user_project" class="form-control" required>
				...
				<?php foreach ($all_projects as $key => $value): ?>
					<option value="<?php echo $value['project_id']; ?>" <?php if(@$selected_factors_list[0]['tlhr_project'] ==$value['project_id']){ echo 'selected';} ?>><?php echo $value['project_name']; ?></option>
				<?php endforeach ?>
			</select>
		</div>
		<div class="col-md-2">
	  	...
	  	<?php $i=1; foreach ($selected_factors_list as $key => $value): ?>
			...
			<td colspan  ="7" >
	  		<div class="question-wrapper set1">
                <div class="statement">
                    <?php echo '<b>'.$value['tlhr_cat_name'].' : </b>'.$value['tlhr_eval_description']; ?>
                </div>
...
<div class="overall-rating">
	<label class="custom-control custom-radio" >
	  	<input id="radio1" name="overall_rating" type="radio" value="(05-06)" class="custom-control-input" <?php echo  set_radio('overall_rating', '(05-06)', @$value['tlhr_overall_rating'] == '(05-06)' ); ?> required>
	...
	<label class="custom-control custom-radio">
	  	<input id="radio1" name="overall_rating" type="radio" value="(04-05)" class="custom-control-input" <?php echo  set_radio('overall_rating', '(04-05)', @$value['tlhr_overall_rating'] == '(04-05)' ); ?> >
	...
	<label class="custom-control custom-radio">
	  	<input id="radio1" name="overall_rating" type="radio" value="(03-04)" class="custom-control-input" <?php echo  set_radio('btn_radio_rating', '(03-04)', @$value['tlhr_overall_rating'] == '(03-04)' ); ?>>
	...
	<label class="custom-control custom-radio">
	  	<input id="radio1" name="overall_rating" type="radio" value="(02-03)" class="custom-control-input" <?php echo  set_radio('btn_radio_rating', '(02-03)', @$value['tlhr_overall_rating'] == '(02-03)' ); ?>>
	...
	<label class="custom-control custom-radio">
	  	<input id="radio1" name="overall_rating" type="radio" value="(01-02)" class="custom-control-input" <?php echo  set_radio('btn_radio_rating', '(01-02)', @$value['tlhr_overall_rating'] == '(01-02)' ); ?>>
